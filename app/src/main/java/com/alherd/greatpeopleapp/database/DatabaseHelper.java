...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String CONCRETE_PROFESSION_SCIENTIST_MATHEMATICIAN = "Математик";
    public static final String CONCRETE_PROFESSION_SCIENTIST_PHYSICIAN = "Физик";
